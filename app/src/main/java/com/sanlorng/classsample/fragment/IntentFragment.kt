...
class IntentFragment : Fragment(), View.OnClickListener {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        toolbar_intent.setOnMenuItemClickListener {
            when (it.itemId) {
                ...
                R.id.openInBrowser -> startActivity(
                    Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://github.com/Sanlorng")
                    )
                )
                R.id.shareIntent -> {
                    ...
                    shareIntent.putExtra(
                        Intent.EXTRA_TEXT,
                        "这是由Sanlorng创建的应用ClassSample分享的内容，用于Android实验内容展示，个人Github地址:https://github.com/Sanlorng"
                    )
                ...
                R.id.sendToMessage -> {
                    ...
                    intent.putExtra(
                        "sms_body",
                        "这是由Sanlorng创建的应用ClassSample发送的内容，用于Android实验内容展示，个人Github地址:https://github.com/Sanlorng"
                    )
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        when (requestCode) {
            1 -> if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) startActivity(
